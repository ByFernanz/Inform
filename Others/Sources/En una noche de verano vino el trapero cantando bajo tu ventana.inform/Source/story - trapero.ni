"En una noche de verano apareció el trapero cantando bajo tu ventana..." by Expio (in Spanish)
...
[Sound of musica is the file "Musica.ogg". ]
...
Check ayudaring:  if the player carry nothing, say "Este es un texto interactivo un tanto particular. Tan solo consta de un puzzle y de una orden válida. El método de juego-interacción es el usual en este tipo de obras: en la barra de comandos debes de escribir lo que deseas hacer, por ejemplo, puedes examinar el entorno -examinar cuna- -tocar la trompeta- -Atacar orco-. Procura pensar lo que escribes y no desesperes si no encuentras el comando correcto, si te lo tomas con calma encontraras la solución.". 
